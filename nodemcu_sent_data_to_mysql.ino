...
const char *host = "YOUR_IP"; //Your pc or server (database) IP, example : 192.168.0.0 , if you are a windows os user, open cmd, then type ipconfig then look at IPv4 Address.
...
void loop() {
  ...
  //put your sensor port and deklare here
  ...
  //same as $_POST['ldrvalue']
  
  http.begin("http://"+String(host)+"/Nodemcu/InsertDB.php");              //Specify request destination
